...
const BookCard = ({
  book: { id, name, thumbnail, author, price, rating, featured },
}) => {
    ...
    <div className="book-card">
      ...
      <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
        <div className="flex items-center justify-between">
          <span
            onClick={() =>
              featured ? handleStatusChange(true) : handleStatusChange(false)
            }
            className="badge-success lws-Badge cursor-pointer"
          >
            {featured ? "Featured" : "All"}
          </span>

          <div className="text-gray-500 space-x-2">
            <button className="lws-edit" onClick={() => handleEdit(id)}>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
